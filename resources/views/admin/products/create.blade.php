...
<div class="tab" style="background-color:{{$back_color}};">
    <div class="form" style="background-color: {{$table_color}}">
        <form name="upl" id="upl" action="{{route('Product.store')}}" method="POST" enctype="multipart/form-data" style="height:98%;width:100%">
            @csrf
            <div class="textarea">
                <label for="" style="color:{{$label_color}}">Desription</label>
                <textarea name="des" id="des" style="border:2px solid {{$input_border}}"></textarea>
            </div>
            <div class="row">
                <div class="column">
                    <div class="txt">
            ...
            <div class="row">
                <div class="column">
                    ...
                    <div class="box">
                        <input type="text" name="name_link" class="form-control @error('name_link') is-invalid @enderror" 
                ...
                <div class="column">
                    ...
                    <div class="box" id="product_update_box">
                        <input type="file" name="photo[]" id="file" class="form-control @error('photo') is-invalid @enderror" 
            ...
            <div class="row">
                <div class="column">
                    ...
                    <div class="box">
                        <input type="text" name="after_dis" id="after_dis" class="form-control @error('after_dis') is-invalid @enderror" 
